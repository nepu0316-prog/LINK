      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 pb-16">
        ...
        <section className="mt-8 pb-4 space-y-3">
          <a href="https://duliduli-website.com" target="_blank" rel="noopener noreferrer"
            className="flex items-center justify-center gap-2 w-full py-4 rounded-xl border-2 border-warm-300 bg-transparent hover:bg-gray-100 text-warm-800 font-bold text-base transition-all shadow-soft hover:shadow-hover">
            🌐 嘟力日記官網
          </a>
          <a href="http://surl.li/xvljif" target="_blank" rel="noopener noreferrer"
            className="flex flex-col items-center justify-center gap-1 w-full py-4 rounded-xl border-2 border-warm-300 bg-transparent hover:bg-gray-100 text-warm-800 font-bold text-base transition-all shadow-soft hover:shadow-hover">
