...
import { EXTERNAL_LINK_IDS } from '@/lib/external-link-ids'
    ...
    <div className="min-h-screen" style={{ backgroundColor: PAGE_BG }}>
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 pb-16">
        ...
        <section className="mt-6 space-y-3">
          <ClickTracker itemType="link" itemId={EXTERNAL_LINK_IDS.WEBSITE}>
            <a
          ...
          <ClickTracker itemType="link" itemId={EXTERNAL_LINK_IDS.LINE_COMMUNITY}>
            <a
